...
function draw() {
  ...
  if (gameState === PLAY) {
     ...
     obstaclesGroup.velocityX = -(4 + 1.9 * score / 105)
    //scoring
...
function spawnObstacles() {
  ...
  if (frameCount % 60 === 0) {
    ...
    obstaclesGroup.setColliderEach("rectangle",0,0, obstaclesGroup.width, obstaclesGroup.height);
  }
}

//function for the spawnBanana
